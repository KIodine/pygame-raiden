...
pygame.mixer.init()
default_sound = pygame.mixer.Sound('music/epic_start.wav')
default_channel = pygame.mixer.Channel(2)

FADE_FLAG = True

def Fade( screen, FPS, BLACK , cap=None, sub=None, sound=None):
    global FADE_FLAG
